...
# TODO: This isnt ready for use yet, its auto generated by json2model, needs to be refined
...
class Distance_Duration(BaseModel):
    text: Literal["15.7 km", "19 mins", "2.1 km", "20.3 km", "29 mins", "6 mins"]
    value: int