...
class TestNavigation(TestCase):
    ...
    def test_distance_matrix(self):
        ...
        self.assertEqual(responses.calls[0].request.url, "https://maps.googleapis.com/maps/api/distancematrix/json?destinations=50.1350588%2C+8.917969800000002%7C50.14437%2C+8.7201301%7C50.121089%2C+8.6875334&origins=50.1415865%2C+8.8984939&key=AIzaSyD6z4WhJMY85Xgc9ZIRTMbCgr1zfSIMhUg")

    def test_calculate_fuel_consumption(self):
        res_city, _ = navigation.calculate_fuel_consumption(distance=2000, duration=140,avg_city_fuelconsumption=10, avg_motorway_fuelconsumption=7)
        expected_res_city = 0.2
        self.assertEqual(res_city, expected_res_city)

        res_motorway, _ = navigation.calculate_fuel_consumption(distance=2000, duration=40, avg_city_fuelconsumption=10, avg_motorway_fuelconsumption=7)
